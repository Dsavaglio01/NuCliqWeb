  ...
  return (
    <div className='my-7 border-rounded-sm w-96 relative flex flex-col justify-center' style={{ 
      ...
      backgroundPosition: 'center',
        ...
        focusedItem={focusedItem} handleData={setTempPosts} blockedUsers={blockedUsers} closeCommentModal={() => setCommentModal(false)} pfp={pfp} user={user}/>
        ...
        <SendingModal sendingModal={sendingModal} payloadUsername={item.username} payload={item} closeSendingModal={() => setSendingModal(false)} video={false} theme={false} post={true} user={user} 
